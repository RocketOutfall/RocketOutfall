...
<div style="height: 500px; width: 100%; color: #FFF; display:flex; justify-content:center; align-items:center; text-align: center;">

<span style="font-family: Oswald, bold; font-size: 70px;">SHORT TITLE TITLE</span>
<br />
<span style="font-family: Courgette, cursive; font-size: 30px;">Finding the best solution for loads of treated groundwater</span>
